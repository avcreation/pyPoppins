...
class X509Certificate(object):
    ...
    def __init__(self, cert_buffer=None, cert_filename=None):
        ...
        self.not_before = reformat_cert_date(self.x509.get_notBefore())
        self.not_after = reformat_cert_date(self.x509.get_notAfter())
    ...
    def get_not_before_datetime(self):
        ...
        return parse_from_cert_date(self.x509.get_notBefore())

    def get_not_after_datetime(self):
        """ Return the datetime of not after certificate """
        return parse_from_cert_date(self.x509.get_notAfter())


def parse_from_cert_date(cert_datetime):
    ...
    """
    # ensure consistent string for cert_datetime
    cert_datetime = cert_datetime.decode('utf-8')
    # convert cert string date to datetime
    return datetime.datetime.strptime(cert_datetime, "%Y%m%d%H%M%SZ")


def reformat_cert_date(cert_datetime):
    ...
    """
    datetime_obj = parse_from_cert_date(cert_datetime)
